        ...
        {transactions.length === 0 ? (
          ...
          <div className="space-y-4">
            {transactions.slice(0, 5).map((tx, idx) => (
              <div key={idx} className="flex items-center justify-between p-5 hover:bg-slate-50/80 rounded-2xl transition-all border border-transparent hover:border-slate-100 group">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-500 font-bold mt-1 uppercase tracking-widest flex items-center gap-1.5">
